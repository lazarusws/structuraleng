...
function designSection(){
    ...
    do {
        ...
        var design_section_area = Math.min(A_steel_flange_section,A_steel_web_section);  // The design section area is guided by the least section class( 1 is the maximum and 4 is the minimum section class)
